...
install:
	...
	dfx canister install --argument='(vec { principal "'$(shell dfx canister id agg0)'" })' ledger
...
reinstall:
	...
	echo yes | dfx canister install --mode reinstall --argument='(vec { principal "'$(shell dfx canister id agg0)'" })' ledger
